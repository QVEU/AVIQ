...
metadata = {
    "protocolName": "Fix and Stain (3 plates)",
    "author": "Leonardo Giordano",
    "created": "2024-08-05T14:28:45.837Z",
    "lastModified": "2025-11-25T17:22:40.211Z",
...
def run(protocol: protocol_api.ProtocolContext) -> None:
    ...
    pipette_left.transfer_with_liquid_class(
        ...
        dest=[reservoir_2["A10"], reservoir_2["A10"], reservoir_2["A10"], reservoir_2["A10"], reservoir_2["A10"], reservoir_2["A10"]],
        new_tip="never",
        trash_location=protocol.fixed_trash,
        keep_last_tip=True,
        group_wells=False,
    ...
    pipette_left.transfer_with_liquid_class(
        ...
        dest=[reservoir_2["A9"], reservoir_2["A9"], reservoir_2["A9"], reservoir_2["A9"], reservoir_2["A9"], reservoir_2["A9"]],
        new_tip="never",
        trash_location=protocol.fixed_trash,
        keep_last_tip=True,
        group_wells=False,
    ...
    pipette_left.transfer_with_liquid_class(
        ...
        dest=[reservoir_4["A12"], reservoir_4["A12"], reservoir_4["A12"], reservoir_4["A12"], reservoir_4["A12"], reservoir_4["A12"]],
        new_tip="once",
        trash_location=protocol.fixed_trash,
        keep_last_tip=True,
        group_wells=False,
    ...
    pipette_left.transfer_with_liquid_class(
        ...
        dest=[reservoir_4["A11"], reservoir_4["A11"], reservoir_4["A11"], reservoir_4["A11"], reservoir_4["A11"], reservoir_4["A11"]],
        new_tip="never",
        trash_location=protocol.fixed_trash,
        keep_last_tip=True,
        group_wells=False,
    ...
    # Step 9: A MeOH P1 (12-7)
    pipette_left.distribute_with_liquid_class(
        volume=100,
        source=[reservoir_3["A1"]],
